...
statistic_calculation <- function(data_frame_list, stat = "mean") {
  ...
  # Naming the vector
  names(stat_vector) <- c("Pre-Treatment BP Statistic", "Post-Treatment BP Statistic", "Difference (Pre-Post) Treatment BP Statistic", "Pre-Placebo BP Statistic", "Post-Placebo BP Statistic", "Difference (Pre-Post) Placebo BP Statistic")
  return(stat_vector)
}
```